    ...
    $.fn.onepage_scroll = function (options) {
        ...
        $.each(sections, function (i) {
            ...
            if (settings.pagination == true) {
                ...
                paginationList += "<li><a data-index='" + (i + 1) + "' href='#" + (i + 1) + "'><span class='menu-name-" + (i + 1) + "'></span></a></li>"
            }
        });
        el.swipeEvents().bind("swipeDown", function (event) {
            if (!$("body").hasClass("disabled-onepage-scroll"))
        ...
        if (settings.pagination == true) {
            ...
            $("a.nav-top.1").click(function () {
                el.moveTo(1);
            });
            $("a.nav-top.2").click(function () {
                el.moveTo(2);
            });
            $("a.nav-top.3").click(function () {
                el.moveTo(3);
            });
            $("a.nav-top.4").click(function () {
                el.moveTo(4);
            });
            $("a.nav-bottom.2").click(function () {
                el.moveTo(2);
            });
            $("a.nav-bottom.3").click(function () {
                el.moveTo(3);
            });
            $("a.nav-bottom.4").click(function () {
                el.moveTo(4);
            });
            $("a.nav-bottom.5").click(function () {
                el.moveTo(5);
            });
